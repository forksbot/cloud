...
//    pub fn new(error: LambdaError) -> Self {
//        Self {
...
//
//#[derive(Debug, PartialEq)]
//pub struct InvocationOkRequest {
//    path: PathAndQuery,
//    body: Vec<u8>,
//}
//
//impl InvocationOkRequest {
//    pub fn new(request_id: String, body: Vec<u8>) -> Self {
...
//}
//#[derive(Debug, PartialEq)]
//pub struct InvocationErrorRequest {
//    path: PathAndQuery,
//    error: LambdaError,
//}
//
//impl InvocationErrorRequest {
//    pub fn new(request_id: String, error: LambdaError) -> Self {
